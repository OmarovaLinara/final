...
<div class="row">
		<div class="col-md-8 col-md-offset-2" style = " width: 600px; padding:15px; border:1px solid #DEDEDE; border-radius:20px; margin-top:20px; margin-left: 90px;">
			<div class="col-md-5" style="margin-left:65px; border-right:2px dashed #DEDEDE;">
			  <h3>Register</h3>
			  ...
			  <div class="form-group">
			    ...
			    <input ng-model="password" type="password" class="form-control" id="pass" placeholder="Password">
			  </div>
			  <button ng-click="reg_admin()" type="submit" class="btn btn-success">Register</button>
